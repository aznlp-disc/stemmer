...
if __name__ == '__main__':
    ...
    # Generate your text.
    my_text = '''
    Təbii dilin emalı. Dənizin suyu. Qızın çöhrəsi. Onun kitabının.
    Hər abidənin qədim bir tarixi var. Özünü Azərbaycanın işğal olunmuş ərazilərində
     yaradılan qondarma rejimin “başçısı” adlandıran Bako Saakyanın ABŞ-a səfəri
      Vaşinqton və Bakı arasında strateji tərəfdaşlığa təsir etməyəcək.
    '''
